...
module {
  ...
  // never discarded and is flagged for admin review.
  type LatePayment = {
    reference : Text;
    token : Token;
    receivedAmount : Nat;
  ...
  type NewActor = {
    ...
    minimumOrder : { var minimumOrder : Nat };
    feeCache : FeeCache;
    // Late payments received after expiry, flagged for admin review. Starts
    // empty: no late payments existed before this feature.
