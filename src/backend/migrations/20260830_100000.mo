  ...
  public func migration(old : OldActor) : NewActor {
    {
      ...
      // Existing orders predate the shipping and marketing-consent features:
      // set shipping_status = #pending, shipped_at = null, tracking_number =
      // null, marketing_consent = false, and marketing_consent_at = null for
      // every order. The consent checkbox is never pre-checked, so no
      // historical order is assumed to have consented.
      orders = old.orders.map(func o = {
        o with
