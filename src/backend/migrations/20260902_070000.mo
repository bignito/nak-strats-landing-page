...
module {
  ...
  // (20260902_060000.mo): the deployed stable shape before this change. ----
  type ProductVariant = {
    id : Text;
    name : Text;
    size : Text;
  ...
  // NewActor adds the admin-editable featured video config (the raw URL the
  // admin pasted plus the normalized embed URL), seeded empty. All other stable
  ...
  public func migration(old : OldActor) : NewActor {
    {
      ...
      featuredVideo = { var rawUrl = ""; var embedUrl = "" };
    };
  };
};
